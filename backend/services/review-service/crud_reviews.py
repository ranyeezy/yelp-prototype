...
def create_review(user_id: str, payload: schemas.ReviewCreate):
    ...
    review_doc = {
        ...
        "comment": getattr(payload, "comment", "") or "",
    ...
    created["restaurant_id"] = str(created["restaurant_id"])
    return created
...
def get_review(review_id: str):
    ...
    review["comment"] = review.get("comment", review.get("text", ""))
    review["photo_url"] = review.get("photo_url")
    return review
